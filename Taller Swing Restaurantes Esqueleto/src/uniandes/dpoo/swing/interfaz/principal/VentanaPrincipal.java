...
public class VentanaPrincipal extends JFrame
{
    ...
    public void mostrarVetanaNuevoRestaurante() {
        if (ventanaAgregar == null || !ventanaAgregar.isVisible()) {
            // Crear una nueva ventana solo si no existe o está cerrada
            ventanaAgregar = new VentanaAgregarRestaurante();
        } else {
            // Si la ventana ya existe y está abierta, la trae al frente
